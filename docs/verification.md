...
This page records what I tested. I verified the project locally on 2026-08-22 and reran it after the 2026-08-24 name change, using StataNow/MP 19.5. Both do-files pin `version 18`, and the project uses only commands available in Stata 18.
